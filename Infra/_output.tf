...
//   value = local.ecs_destroy_trigger_flag == true ? null : aws_ecs_service.ecs_service[*].name
// }
...
//   value = local.ecs_destroy_trigger_flag == true ? null : local.deployment_controller
// }
